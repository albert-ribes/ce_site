...
urlpatterns = [
    ...
    url(r'^calendar/(?P<location>[-\w]+)/(?P<mode>[-\w]+)/(?P<year>[-\w]+)/(?P<month>[-\w]+)/$', views.calendar_filter, name='calendar'),
    ...
    url(r'^delete_register/(?P<pk>\d+)/$', views.register_delete, name='register_delete'),
    url(r'^delete_event/(?P<pk>\d+)/$', views.event_delete, name='event_delete'),
    ...
    url(r'^insert_register/', views.insert_register, name='insert_register'),
